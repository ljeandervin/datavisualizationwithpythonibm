...
app.layout = html.Div(children=[
    ...
    html.Div([html.Div([html.Div([html.H2('Report Type:', style={'margin-right': '2em'}),]),dcc.Dropdown(id='input-type',options=[{'label': 'Yearly Airline Performance Report', 'value': 'OPT1'},{'label': 'Yearly Airline Delay Report', 'value': 'OPT2'},],value='Select a report type',style={'textAlign': 'center','width':'80%', 'padding':3,'font-size':20}),
    html.Div(id='dd-output-container')])],style={'display':'flex'}),
    html.Div([html.Div([html.H2('Choose Year:', style={'margin-right': '2em'})]),dcc.Dropdown(id='input-year',options=[{'label': i, 'value': i} for i in year_list],placeholder="Select a year",style={'width':'80%', 'padding':'3px', 'font-size': '20px', 'text-align-last' : 'center'}),]),
    html.Div([ ], id='plot1'),
    html.Div([html.Div([ ], id='plot2'),html.Div([ ], id='plot3')], style={'display': 'flex'}),
    html.Div([html.Div([ ], id='plot4'),html.Div([ ], id='plot5')], style={'flex'})])
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            line_fig = px.line(df, x="month", y="AirTime", color="Reporting_Airline", title='Average monthly flight time (minutes) by airline')
